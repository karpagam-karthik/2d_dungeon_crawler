...
public class SprintFiveTestCases {
    ...
    public void testFireFlower() {
        ...
        test.setStartY(40);
        target3.attackPlayer();
        boolean rtn = GameView.getFireballRange() >= 500;
        assertTrue("The players fire attack did not increase", rtn);
    }
    ...
    public void testIceFlower() {
        ...
        Player test = Player.getInstance();
        IcePowerUp target3 = new IcePowerUp(null, 100,100);
        test.setStartX(30);
        test.setStartY(40);
        int prev1 = target1.getMovementSpeed();
        int prev2 = target2.getMovementSpeed();
        target3.attackPlayer();
